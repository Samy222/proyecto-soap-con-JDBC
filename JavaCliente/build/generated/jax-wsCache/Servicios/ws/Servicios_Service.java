 ...
 * 
 */
@WebServiceClient(name = "Servicios", targetNamespace = "http://WS/", wsdlLocation = "http://localhost:8080/InventarioServer/Servicios?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOS_QNAME = new QName("http://WS/", "Servicios");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/InventarioServer/Servicios?wsdl");
    ...
    public Servicios getServiciosPort() {
        return super.getPort(new QName("http://WS/", "ServiciosPort"), Servicios.class);
    }
    ...
    public Servicios getServiciosPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WS/", "ServiciosPort"), Servicios.class, features);
    }
